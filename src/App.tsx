...
export const EPISODES = [
  ...
  { path: "/lesson/5", no: 5, short: "AI와 바이브 코딩", title: "AI 시대의 개발", minutes: 45,
    desc: "LLM의 동작 원리부터, 코딩 없이 동작하는 결과물을 만들고 그 뒷단(API)까지 직접 설계해 보는 시간",
    goals: ["LLM·프롬프트·토큰·할루시네이션을 이해한다", "바이브 코딩으로 프로토타입을 만들 수 있다", "API 명세(주소·방식·주고받을 내용)를 직접 설계해 개발자와 논의할 수 있다", "AI 시대에도 개발자가 필요한 이유를 설명한다"] },
